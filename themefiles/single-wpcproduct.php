...
<div id="wpc-catalogue-wrapper">
    ...
    <!--col-2-->
    <?php $i = 1; ?>
    <?php if (get_option('wpc_sidebar') == yes) { ?>
        <div id="wpc-col-2">
    <?php } else { ?>
            <div id="wpc-catalogue-wrapper">
    <?php } ?>
        ...
        <?php $product_price = get_post_meta($post->ID, 'Product Price', true); ?>
                    <?php if (get_option('wpc_show_title') == yes) { ?><h4><?php echo $show_title ?><?php } else {
                        ?>
                            Product Details  <?php } if ($product_price): ?><span class="product-price">Price: <span><?php echo $product_price; ?></span></span><?php endif; ?></h4>
                    <article class="post">

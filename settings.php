...
?>
        <div class="wpc-left">
            ...
            <div class="wpc-inner">
                <p class="description">
                    <?php _e('Adjust the basic presentation of your product catalogue here. It is important to set this up before you start uploading products so the plugin knows what size to generate thumbnails and product images','wpc') ?>
                </p>
                <p class="description">
                    <?php _e('You can further customise the design of your product catalogue in your theme css.','wpc') ?>
                </p>
                ...
                ?>
                    <table class="form-table" id="catalogue-settings-tabls">
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <label for="wpc_grid_rows"><?php _e('Grid Rows','wpc') ?></label>
                                </th>
                                <td>
                                    <select id="wpc_grid_rows" name="wpc_grid_rows">
                                        <option value="2" <?php if(get_option('wpc_grid_rows')==2){echo 'selected="selected"';} ?>>
                                            2
                                        </option>
                                        <option value="3" <?php if(get_option('wpc_grid_rows')==3){echo 'selected="selected"';} ?>>
                                            3
                                        </option>
                                        <option value="4" <?php if(get_option('wpc_grid_rows')==4){echo 'selected="selected"';} ?>>
                                            4
                                        </option>
                                        <option value="5" <?php if(get_option('wpc_grid_rows')==5){echo 'selected="selected"';} ?>>
                                            5
                                        </option>
                                        <option value="6" <?php if(get_option('wpc_grid_rows')==6){echo 'selected="selected"';} ?>>
                                            6
                                        </option>
                                        <option value="7" <?php if(get_option('wpc_grid_rows')==7){echo 'selected="selected"';} ?>>
                                            7
                                        </option>
                                        <option value="8" <?php if(get_option('wpc_grid_rows')==8){echo 'selected="selected"';} ?>>
                                            8
                                        </option>
                                        <option value="9" <?php if(get_option('wpc_grid_rows')==9){echo 'selected="selected"';} ?>>
                                            9
                                        </option>
                                        <option value="10" <?php if(get_option('wpc_grid_rows')==10){echo 'selected="selected"';} ?>>
                                            10
                                        </option>
                                    </select>
                                    <span><?php _e('products per row','wpc') ?></span>
                                </td>
                            </tr>
                            <!--Color choose - New feature-->
                            <tr valign="top">
                                <th scope="row">
                                    <label for="colorPicker"><?php _e('Choose Theme Color','wpc') ?></label>
                                </th>
                                <td>
                                    <input type="text" value="<?php if(get_option('templateColorforProducts')){ echo get_option('templateColorforProducts'); }else {echo "#000000";} ?>" class="templateColorforProducts" name="templateColorforProducts" id="templateColorforProducts" />
                                </td>
                            </tr>
                            <tr valign="top">
                                <th scope="row">
                            ...
                            <tr valign="top">
                                <th scope="row">
                                    <label for="breadcrumbs"><?php _e('Breadcrumbs','wpc') ?></label>
                                </th>
                                <td>
                                    <label><?php _e('ON','wpc'); ?>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <label><?php _e('ON','wpc'); ?>
                                        <input type="radio" name="wpc_show_tags" value="on" <?php if(get_option('wpc_show_tags')=='on'){echo 'checked="checked"';} ?>  />
                                    </label>
                                    <label> <?php _e('OFF','wpc'); ?>
                                        <input type="radio" name="wpc_show_tags" value="off" <?php if(get_option('wpc_show_tags')=='off'){echo 'checked="checked"';} ?> />
                                    </label>
                                </td>
                            </tr>
                            <tr valign="top">
                            ...
                            <tr valign="top">
                                <th scope="row">
                                    <label for="title"><?php _e('Show Product Titles','wpc') ?></label>
                                </th>
                                <td>
                                    <label><?php _e('ON','wpc'); ?>
              ...
              <!--WPC pro version 1.0's feature closing-->
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <?php _e('Horizontal','wpc'); ?>
                                    &nbsp;&nbsp;&nbsp;
                                    <input type="radio" name="wpc_vert_horiz" value="wpc_v" <?php if(get_option('wpc_vert_horiz')=='wpc_v'){echo 'checked="checked"';} ?>/>
                                    <?php _e('Vertical','wpc'); ?>
                                    <br />
                                    <span></span>
                                </td>
                            ...
                            <tr valign="top">
                                <th scope="row">
                                    <label for="inn_temp_head"><?php _e('Inner Template Header','wpc') ?></label>
                                </th>
                                <td>
                                    <textarea name="wpc_inn_temp_head" cols="90" rows="7" class="widefat inn_temp"><?php echo get_option('wpc_inn_temp_head'); ?></textarea>
                                    <small style="position:relative; top:-10px;">
                                        <?php _e('Use this area to add your theme layout divs if you are having problems with inner pages of the catalogue.','wpc') ?>
                                    </small>
                                </td>
                            </tr>
                            <tr valign="top">
                                <th scope="row">
                                    <label for="inn_temp_foot"><?php _e('Inner Template Footer','wpc') ?></label>
                                </th>
                                <td>
                                    <textarea name="wpc_inn_temp_foot" cols="90" rows="7" class="widefat inn_temp"><?php echo get_option('wpc_inn_temp_foot'); ?></textarea>
                                    <small style="position:relative; top:-10px;">
                                        <?php _e('Use this area to close the open divs after the WP Catalogue.','wpc') ?>
                                    </small>
                                </td>
                            </tr>
                        </tbody>
    ...
    <div class="wpc-right-liquid">
        <table cellpadding="0" class="widefat" style="margin-bottom:10px;" width="50%">
            <thead>
                <th scope="col">
                    <strong style="color:#008001;"><?php _e('How to use this plugin','wpc') ?></strong>
                </th>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <td style="border:0;">
                        <b>2. [wp-catalogue featured="true"]</b>  <?php _e('to display featured products anywhere on your blog.','wpc') ?>
                    </td>
                </tr>
                <tr>
                    <td style="border:0;">
                        <b>3. [wp-catalogue wpcat="wpc-category-slug"] </b> <?php _e('to display products from specific category.','wpc') ?>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table cellpadding="0" class="widefat donation" style="margin-bottom:10px; border:solid 2px #008001;" width="50%">
            <thead>
                <th scope="col">
                    <strong style="color:#008001;"><?php _e('Help Improve This Plugin!','wpc') ?></strong>
                </th>
            </thead>
            <tbody>
                <tr>
